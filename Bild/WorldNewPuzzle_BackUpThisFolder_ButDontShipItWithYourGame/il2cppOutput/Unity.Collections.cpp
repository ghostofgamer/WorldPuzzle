...
{
	{
		//<source_info:./Library/PackageCache/com.unity.burst@1.8.15/Runtime/FunctionPointer.cs:40>
		intptr_t L_0 = ___0_ptr;
		__this->____ptr = L_0;
		//<source_info:./Library/PackageCache/com.unity.burst@1.8.15/Runtime/FunctionPointer.cs:41>
		return;
	}
}
