...
{
	Exception_t* ____opndException = il2cpp_codegen_get_marshal_directive_exception("Cannot marshal field '_opnd' of type 'NodeSet': Reference type field marshaling is not supported.");
